  ...
  create view "sql_dwh_db"."gold"."fact_sales__dbt_tmp"
...
WITH customer_dim AS (
    SELECT *
    FROM "sql_dwh_db"."gold"."dim_customers_current"
),
products_dim AS (
    SELECT *
    FROM "sql_dwh_db"."gold"."dim_products_current"
),
source_sales_data AS (
    SELECT *
    FROM "sql_dwh_db"."silver"."crm_sales_details"
),
