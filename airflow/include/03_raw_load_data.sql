...
TRUNCATE TABLE raw.raw_crm_cust_info;
...
FROM '/home/input_data/source_crm/cust_info_1.csv'
WITH (FORMAT CSV, HEADER TRUE, DELIMITER ',');

TRUNCATE TABLE raw.raw_crm_prd_info;
COPY raw.raw_crm_prd_info(prd_id,prd_key,prd_nm,prd_cost,prd_line,prd_start_dt,prd_end_dt)
FROM '/home/input_data/source_crm/prd_info_1.csv'
WITH (FORMAT CSV, HEADER TRUE, DELIMITER ',');

TRUNCATE TABLE raw.raw_crm_sales_details;
...
FROM '/home/input_data/source_crm/sales_details_1.csv'
WITH (FORMAT CSV, HEADER TRUE, DELIMITER ',');

TRUNCATE TABLE raw.raw_erp_loc_a101;
COPY raw.raw_erp_loc_a101(CID,CNTRY)
FROM '/home/input_data/source_erp/loc_a101_1.csv'
WITH (FORMAT CSV, HEADER TRUE, DELIMITER ',');

TRUNCATE TABLE raw.raw_erp_cust_az12;
COPY raw.raw_erp_cust_az12(CID,BDATE,GEN)
FROM '/home/input_data/source_erp/cust_az12_1.csv'
WITH (FORMAT CSV, HEADER TRUE, DELIMITER ',');

TRUNCATE TABLE raw.raw_erp_px_cat_g1v2;
COPY raw.raw_erp_px_cat_g1v2(ID,CAT,SUBCAT,MAINTENANCE)
FROM '/home/input_data/source_erp/px_cat_g1v2_1.csv'
WITH (FORMAT CSV, HEADER TRUE, DELIMITER ',');